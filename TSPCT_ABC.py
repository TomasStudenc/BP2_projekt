...
def ABC(cords, params):
    ...
    out_population = [Outlooker() for _ in
                      range(int(bee_count * outlooker_rate))]  # vytvornie populácie prihliadajúcich včiel
    ...
    for g in range(generations):
        ...
        e_population = sorted(e_population, key=lambda x: x.fitness)[
                       :int(bee_count * employ_rate)]  # usporiadanie populácie
